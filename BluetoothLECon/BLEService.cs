namespace BluetoothLECon
{
    ...
    internal class BLEService
    {
        ...
        public static Guid ConvertShortIdToUuid(ushort shortId)
        {
            ...
            bytes[0] = (byte)(shortId & 0xFF);
            bytes[1] = (byte)(shortId >> 8);
            return new Guid(bytes);
        }

        public static GattNativeServiceUuid? GetServiceNativeType(GattDeviceService service)
        {
        ...
        {
            return GetServiceNativeType(service)?.ToString() ?? "Custom Service: " + service.Uuid;
        }

        public static GattNativeCharacteristicUuid? GetNativeCharacteristicType(GattCharacteristic characteristic)
        {
